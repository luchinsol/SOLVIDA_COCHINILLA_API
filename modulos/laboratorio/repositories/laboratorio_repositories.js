...
export const crearAnalisis = async (datos) => {
    const query = `
        INSERT INTO laboratorio.analisis_laboratorio (usuario_id, proceso_extraccion_id, tipo_material, material_id, tipo_analisis, fecha_hora, concentracion_ac, humedad, color_l, color_a, color_b, observaciones)
...
export const actualizarAnalisis = async (id, datos) => {
    const query = `
        UPDATE laboratorio.analisis_laboratorio SET usuario_id=$1, proceso_extraccion_id=$2, tipo_material=$3, material_id=$4, tipo_analisis=$5, fecha_hora=$6, concentracion_ac=$7, humedad=$8, color_l=$9, color_a=$10, color_b=$11, observaciones=$12
